<form action="<?php echo esc_url(home_url( '/' )); ?>" method="get" class="form-group search-form">
    <div class="input-group pb-3">
        <input type="text" name="s" id="search" value="<?php the_search_query(); ?>" class="form-control" placeholder="<?php esc_html_e('Search ...', 'world-times') ?>">
